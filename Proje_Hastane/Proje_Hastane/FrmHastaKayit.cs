...
namespace Proje_Hastane
{
    public partial class FrmHastaKayit : Form
    {
        ...
        {
            SqlCommand komut1 = new SqlCommand("Insert Into Tbl_Hastalar (HastaAd,HastaSoyad,HastaTC,HastaTelefon,HastaSifre,HastaCinsiyet) Values (@p1,@p2,@p3,@p4,@p5,@p6)", bgl.baglanti());
